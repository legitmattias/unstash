...
def spec(filename: str, doc_type: str, date: str, brief: str, anchors: list[str], style: str = "") -> dict:
    return {
        "filename": filename,
        "doc_type": doc_type,
        "date": date,
...
SPECS: list[dict] = [
    # --- styrelseprotokoll ---------------------------------------------------
    spec("protokoll-styrelse-2019-11.md", "styrelseprotokoll", "2019-11-14",
    ...
    spec("protokoll-styrelse-2020-03.md", "styrelseprotokoll", "2020-03-12",
    ...
    spec("protokoll-styrelse-2020-09.md", "styrelseprotokoll", "2020-09-17",
    ...
    spec("protokoll-styrelse-2021-05.md", "styrelseprotokoll", "2021-05-20",
    ...
    spec("protokoll-styrelse-2021-09.md", "styrelseprotokoll", "2021-09-16",
    ...
    spec("protokoll-styrelse-2022-02.md", "styrelseprotokoll", "2022-02-10",
    ...
    spec("protokoll-styrelse-2022-04.md", "styrelseprotokoll", "2022-04-21",
    ...
    spec("protokoll-styrelse-2022-05.md", "styrelseprotokoll", "2022-05-19",
    ...
    spec("protokoll-styrelse-2022-11.md", "styrelseprotokoll", "2022-11-17",
         "Ordinary meeting. Budget 2023: fee UNCHANGED. Planning for the 2023 roof works "
         "communication to members. Christmas gathering.",
         ["oförändrad", "2023"]),
    spec("protokoll-styrelse-2023-03.md", "styrelseprotokoll", "2023-03-16",
    ...
    spec("protokoll-styrelse-2023-05.md", "styrelseprotokoll", "2023-05-25",
    ...
    spec("protokoll-styrelse-2023-09.md", "styrelseprotokoll", "2023-09-21",
    ...
    spec("protokoll-styrelse-2023-11.md", "styrelseprotokoll", "2023-11-16",
         ...
         ["§ 4", "3,5 %", "avgiften"]),
    spec("protokoll-styrelse-2024-02.md", "styrelseprotokoll", "2024-02-15",
    ...
    spec("protokoll-styrelse-2024-05.md", "styrelseprotokoll", "2024-05-23",
    ...
    spec("protokoll-styrelse-2024-09.md", "styrelseprotokoll", "2024-09-19",
    ...
    spec("protokoll-styrelse-2024-11.md", "styrelseprotokoll", "2024-11-21",
         ...
         ["Naturvårdsverket", "50 %"]),
    spec("protokoll-styrelse-2025-02.md", "styrelseprotokoll", "2025-02-13",
    ...
    # --- stämmoprotokoll -----------------------------------------------------
    spec("protokoll-stamma-2020.md", "stämmoprotokoll", "2020-06-11",
    ...
    spec("protokoll-stamma-2021.md", "stämmoprotokoll", "2021-06-10",
         "Annual general meeting. Standard items; information about the upcoming roof "
         "inspection; no motions.",
         ["ansvarsfrihet", "tak"]),
    spec("protokoll-stamma-2022.md", "stämmoprotokoll", "2022-06-09",
    ...
    spec("protokoll-stamma-2023.md", "stämmoprotokoll", "2023-06-08",
    ...
    spec("protokoll-stamma-2024.md", "stämmoprotokoll", "2024-06-13",
    ...
    spec("protokoll-stamma-2025.md", "stämmoprotokoll", "2025-06-12",
    ...
    # --- ekonomi -------------------------------------------------------------
    spec("budget-2021.md", "ekonomi", "2020-12-01",
    ...
    spec("ekonomisk-rapport-2023-h2.md", "ekonomi", "2023-12-15",
    ...
    # --- avtal & offerter ----------------------------------------------------
    spec("offert-norrbygg-2022.md", "offert", "2022-03-28",
    ...
    spec("offert-takexperten-2022.md", "offert", "2022-04-02",
    ...
    spec("avtal-norrbygg-2022.md", "avtal", "2022-06-15",
    ...
    spec("garantibevis-tak-2023.md", "avtal", "2023-09-15",
    ...
    spec("offert-gronel-2024.md", "offert", "2024-01-20",
    ...
    spec("avtal-tradgardsteam-2024.md", "avtal", "2024-04-01",
    ...
    spec("info-takrenovering-2023.md", "medlemsinfo", "2023-05-30",
    ...
    spec("info-tvattstuga-app-2023.md", "medlemsinfo", "2023-04-05",
    ...
    spec("motion-hundrastgard-2022.md", "motion", "2022-04-30",
    ...
    spec("kallelse-stamma-2024.md", "kallelse", "2024-05-20",
    ...
    spec("info-laddstolpar-2025.md", "medlemsinfo", "2025-03-01",
    ...
    # --- regler & stadgar ----------------------------------------------------
    spec("trivselregler-2020.md", "regler", "2020-09-17",
    ...
    spec("trivselregler-2023.md", "regler", "2023-06-01",
    ...
    spec("stadgar-utdrag.md", "stadgar", "2019-01-01",
    ...
    spec("beslut-vindsombyggnad-1998.md", "styrelseprotokoll", "1998-10-08",
    ...
    spec("protokoll-garage-2005.md", "styrelseprotokoll", "2005-04-14",
    ...
    with httpx.Client() as client:
        for s in SPECS:
            ...
            if missing:
                ...
                missing = missing_anchors(text, s)
            header = f"<!-- synthetic eval document | type: {s['doc_type']} | date: {s['date']} -->\n\n"
