...
| `database_admin_password.txt` | PostgreSQL password for the `unstash_admin` user (DML only, BYPASSRLS, used only by superuser-gated admin endpoints) | `openssl rand -base64 32` |
